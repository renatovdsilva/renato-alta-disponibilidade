...
O detalhe completo está em [`docs/01-instalacao.md`](01-instalacao.md).
...
| 01a | [Instalação do WSL2](01-instalacao-wsl2.md) | Virtualização, WSL2, Ubuntu, .wslconfig, Docker Desktop |
| 01b | [Instalação das ferramentas](01-instalacao.md) | kubectl, k3d, Helm |
