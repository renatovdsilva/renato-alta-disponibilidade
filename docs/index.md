...
O detalhe completo está em [`docs/01b-instalacao-ferramentas.md`](01b-instalacao-ferramentas.md).
...
|---|---|---|
| 00 | [Ponto de partida](00-ponto-de-partida.md) | Estado inicial da máquina, objetivos e critérios de sucesso |
| 01a | [Instalação do WSL2](01a-instalacao-wsl2.md) | Virtualização, WSL2, Ubuntu, .wslconfig, Docker Desktop |
| 01b | [Instalação das ferramentas](01b-instalacao-ferramentas.md) | kubectl, k3d, Helm |
| 02 | [Criação do cluster](02-cluster.md) | k3d, 3 nós, Ingress NGINX |
| 03 | [Containerização](03-containerizacao.md) | Dockerfiles multi-stage, import de imagens |
| 04 | [Deploy](04-deploy.md) | Deployments, Services, Ingress, testes de resiliência |
| 05 | [Helm](05-helm.md) | Charts, values por ambiente, rollback |
| 06 | [Monitorização](06-monitorizacao.md) | Prometheus, Grafana, alertas |
| 07 | [GitOps](07-gitops.md) | ArgoCD, sincronização automática, self-heal |
| 08 | [Operação](08-operacao.md) | Rotina diária, publicação de versões, backup |
| 09 | [Troubleshooting](09-troubleshooting.md) | Problemas encontrados e como foram resolvidos |
| 10 | [Decisões de arquitetura](10-decisoes.md) | Escolhas, alternativas e custos |
| 11 | [Métricas](11-metricas.md) | Números medidos, base dos bullets do currículo |
